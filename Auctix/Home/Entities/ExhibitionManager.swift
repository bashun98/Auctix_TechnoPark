...
class ExhibitionManager: ExhibitionManagerProtokol {
    ...
    func loadExhibition() -> [Exhibition] {
        return [
            Exhibition(titleImg: #imageLiteral(resourceName: "Search"), title: "House Kult", text_opis: "dsfghj sdhfjikf hjkh sdfhjk f hjksdf  sdhhsd hsdfhfhjks  dhhd"),
            Exhibition(titleImg: #imageLiteral(resourceName: "BidTabBar"), title: "House Kult", text_opis: "dsfghj sdhfjikf hjkh sdfhjk f hjksdf  sdhhsd hsdfhfhjks  dhhd"),
            Exhibition(titleImg: #imageLiteral(resourceName: "AccTabBar"), title: "House Kult", text_opis: "dsfghj sdhfjikf hjkh sdfhjk f hjksdf  sdhhsd hsdfhfhjks  dhhd")
        ]
    }
